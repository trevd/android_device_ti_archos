...
set_light_keyboard(struct light_device_t* dev,
        struct light_state_t const* state)
{
    /* There is not keyboard on the archos Tablet */
    return 0;
}
...
set_light_battery(struct light_device_t* dev,
        struct light_state_t const* state)
{
    /* There is not battery LED on the archos Tablet */
    return 0;
}
...
set_light_notification(struct light_device_t* dev,
        struct light_state_t const* state)
{
    /* There is no dedicated notification LED on the archos Tablet */
    return 0;
}
...
set_light_attention(struct light_device_t* dev,
        struct light_state_t const* state)
{
      /* There is no dedicated attention LED on the archos Tablet */
    return 0;
